...
Data sync for all JSON integration files can be triggered by sending GET method request to the /client-data/initialize-db route, with the standard authorization mentioned at the start of the documentation.
