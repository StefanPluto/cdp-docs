...
StopChurn platform is hosted on the following addresses:

### Staging environment

- https://admin-staging.stopchurn.com - StopChurn
- https://marketplace-staging.stopchurn.com - StopChurn backend
- https://notifications-staging.stopchurn.com - Api for websockets

### Production environment

- https://admin.stopchurn.com - StopChurn
- https://marketplace.stopchurn.com - StopChurn backend
- https://notifications.stopchurn.com - Api for websockets

### IP Whitelisting

If you need to whitelist our IPs for callbacks, our outgoing IPs are:

- Staging environment - 3.72.242.182
- Production environment - 18.196.37.128
